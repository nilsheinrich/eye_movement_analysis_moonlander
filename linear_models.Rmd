...
```
## Exploring fixations - Fixation location (distance to closest obstacle in visual degrees)
...
###################### Fixation Data ######################
fixData_exp2 <- read_csv("experimental_data_ii/fixations_moonlander_ii.csv")
...
distant_fixations_exp2 <- fixData_exp2[fixData_exp2$distant_fixation == 1, ]
close_fixations_exp2 <- fixData_exp2[fixData_exp2$distant_fixation == 0, ]


# Writing to arrow
write_feather(distant_fixations_exp2, "experimental_data_ii/Experiment2_DistantFixations.arrow")
write_feather(close_fixations_exp2, "experimental_data_ii/Experiment2_CloseFixations.arrow")

###################### SoC Data ######################
socData_exp2 <- read_csv("experimental_data_ii/soc_data_ii.csv")

write_feather(socData_exp2, "Experiment2_SoCData.arrow")
...
###################### Fixation Data ######################
fixData_exp3 <- read_csv("experimental_data_iii/fixations_moonlander_iii.csv")

# only considering fixations with duration > 0:
fixData_exp3 <- fixData_exp3[fixData_exp3$fixation_duration > 0, ]
# The eye tracker might have flagged single frames as fixations. These would have lasted no time and we will simply filter them out.
...
distant_fixations_exp3 <- fixData_exp3[fixData_exp3$distant_fixation == 1, ]
close_fixations_exp3 <- fixData_exp3[fixData_exp3$distant_fixation == 0, ]


# Writing to arrow
write_feather(distant_fixations_exp3, "Experiment3_DistantFixations.arrow")
write_feather(close_fixations_exp3, "Experiment3_CloseFixations.arrow")

###################### SoC Data ######################
socData_exp3 <- read_csv("experimental_data_iii/soc_data_iii.csv")

write_feather(socData_exp3, "Experiment3_SoCData.arrow")
