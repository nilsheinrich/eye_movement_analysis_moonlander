...
def visualize_sequence(id_code, done_, n_run, arg_comb, start_time, end_time):
    """
    ...
    render_gaming_sequence(input_data=input_data, eye_data=eye_data, start_time=start_time, end_time=end_time)


def render_gaming_sequence(input_data, eye_data, start_time, end_time, scaling=18, edge=34, observation_space_x=40,
                           observation_space_y=60, bottom_edge=15, obstacle_size=2, agent_size_x=2, agent_size_y=2):
    """
