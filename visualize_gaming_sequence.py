...
def visualize_sequence(code, n_run, start_time, end_time, scaling=18, edge=34, observation_space_x=40,
                       observation_space_y=60,
                       bottom_edge=15, obstacle_size=2, agent_size_x=2, agent_size_y=2):
    """
    :param code: participant's experimental code
    :param n_run: which run of participant given above shall be visualized
    ...
    # load data by given code and n_run (with input data being button presses and eye data being eye tracking output)
